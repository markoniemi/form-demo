...
- [x] Initialize Maven multi-module project structure with frontend, backend, and oauth modules
- [x] Set up version control, CI/CD pipelines (GitHub Actions), and code quality tools (ESLint, Prettier, Google Java Format)
- [x] Configure H2 database in backend
- [x] Implement LocalDevelopmentApplication for local development with in-memory OAuth server and H2 database
- [x] Establish basic project structure for all modules (README, pom.xml, Dockerfile, etc.)

### Sprint 2: Authentication & Authorization
- [x] Integrate OAuth 2.0 authentication for form creators and fillers
- [x] Implement OAuth module as Docker container for testing
- [x] Integrate OAuth with backend using Testcontainers
- [x] Secure backend endpoints with Spring Security

### Sprint 3: Form Management (Backend)
- [x] Implement RESTful APIs for form creation, editing, deletion
- [x] Implement data models for forms, fields, and responses using Spring Data JPA
- [x] Add validation and error handling
- [x] Write backend unit and integration tests (using H2 and Testcontainers)
